...
(function () {
  ...
  'Бриф: главное — 7 шагов на 10–15 минут, детали — по желанию; обязательны только имя и телефон; если сомневаетесь — вариант «Не знаю / обсудим»; ответы сохраняются в браузере, можно вернуться позже; файлы до 20 МБ, большие — ссылкой на Диск',
